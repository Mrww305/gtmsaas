      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            ...
            <a href="#features" onClick={() => setMobileOpen(false)} className="text-sm text-slate-300">Features</a>
  ...
  const features = [
    {
      ...
      subtitle: 'LinkedIn Signal Harvester',
      description: 'Capture job changes, profile views, and post engagement in real-time. Automatically trigger workflows when your prospects make moves.',
      stats: [
        { label: 'Signal Types', value: '5' },
        { label: 'Dedup Window', value: '24h' },
        { label: 'Sync Interval', value: '1 min' }
      ]
    },
    {
      icon: '📊',
      title: 'Usage Dashboard',
      subtitle: 'Real-Time Metering',
      description: 'Track enrichments, workflow runs, and costs in real-time. Visual breakdowns by day, workflow, and node type. Never get surprise bills.',
      stats: [
    ...
    },
    {
      ...
      description: 'Invite team members with granular permissions. Owner, Admin, Editor, Viewer roles. Full audit log for compliance.',
      stats: [
        { label: 'Roles', value: '4' },
        { label: 'Audit Log', value: '1 year' },
    ...
    },
    {
      ...
      description: 'Estimate revenue generated by each workflow. Track node performance, cost attribution, and success rates across your entire GTM operation.',
      stats: [
        { label: 'ROI Accuracy', value: '95%' },
        { label: 'Node Metrics', value: '8' },
        { label: 'Time Periods', value: '3' }
      ]
    }
  ];

  return (
    <section id="features" className="relative py-32 bg-slate-900">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          ...
          className="text-center mb-16"
        >
          <span className="text-sm font-medium text-emerald-400 uppercase tracking-wider">Advanced Features</span>
          <h2 className="text-4xl md:text-5xl font-bold text-white mt-4 mb-4">Beyond Orchestration</h2>
          <p className="text-lg text-slate-400 max-w-2xl mx-auto">
            Chrome extension, usage metering, team collaboration, and ROI analytics — everything you need to run a modern GTM operation.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {features.map((feature, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: i * 0.1 }}
              className="p-8 rounded-2xl bg-slate-800/30 border border-white/5 hover:border-emerald-500/20 transition-all"
            >
              <div className="flex items-start gap-4 mb-4">
                <span className="text-4xl">{feature.icon}</span>
                <div>
                  <h3 className="text-xl font-bold text-white">{feature.title}</h3>
                  <p className="text-sm text-emerald-400">{feature.subtitle}</p>
                </div>
              </div>
